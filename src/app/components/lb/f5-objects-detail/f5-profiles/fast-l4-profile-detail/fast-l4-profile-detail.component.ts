...
import {FastL4ProfileComponent} from '../../../objects';
...
@Component({
    selector: 'app-fast-l4-profile-detail',
    templateUrl: '../../../generic-object-detail/generic-object-detail.component.html',
    styleUrls: ['./fast-l4-profile-detail.component.css']
})
export class FastL4ProfileDetailComponent extends GenericObjectDetailComponent {
    ...
    ngOnInit(): void {
        this.title = 'Fast 14 profile detail';
        super.ngOnInit();
        this.component = this.devicesService.getFastL4Profile(this.id, this.hostname);
    }

    // TODO implement in future and move to utils and add close automatic
    public goSelf(): void {
        setTimeout(() => {
            super.goSelf('/fastl4profile');
