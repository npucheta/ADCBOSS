...
import {AWSLoadBalancerComponent} from '../../objects';
import {environment} from '../../../../shared/common';

@Component({
    selector: 'app-awselbdetail',
    templateUrl: '../../generic-object-detail/generic-object-detail.component.html',
    styleUrls: ['./awselbdetail.component.css']
})
export class AWSELBDetailComponent extends GenericObjectDetailComponent {
    ...
    ngOnInit(): void {
        this.title = 'Load Balancer detail';
        super.ngOnInit();
        this.component = this.awsService.getLoadBalancer(this.id, this.hostname);
