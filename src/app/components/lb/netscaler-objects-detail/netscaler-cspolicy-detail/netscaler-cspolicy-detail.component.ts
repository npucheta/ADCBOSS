...
@Component({
    selector: 'app-netscaler-cspolicy-detail',
    ...
    styleUrls: ['./netscaler-cspolicy-detail.component.css']
})
export class NetscalerCSPolicyDetailComponent extends GenericObjectChartDetailComponent {
    ...
    ngOnInit(): void {
        ...
        super.ngOnInit();
        this.component = this.netscalerService.getCSPolicy(this.id, this.hostname);
    ...
    public appMapping(ip: String, port: String): void {
      ...
      public goSelf(): void {
        setTimeout(() => {
            super.goSelf('/netscaler-cspolicy');
