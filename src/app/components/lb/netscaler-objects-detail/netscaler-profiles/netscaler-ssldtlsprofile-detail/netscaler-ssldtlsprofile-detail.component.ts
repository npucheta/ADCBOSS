...
@Component({
    selector: 'app-netscaler-ssldtlsprofile-detail',
    templateUrl: '../../../generic-object-chart-detail/generic-object-chart-detail.component.html',
    styleUrls: ['./netscaler-ssldtlsprofile-detail.component.css']
})
export class NetscalerSSLDTLSProfileDetailComponent extends GenericObjectChartDetailComponent {
    ...
    ngOnInit(): void {
        ...
        super.ngOnInit();
        this.component = this.netscalerService.getSSLDTLSProfile(this.id, this.hostname);
    ...
    public goSelf(): void {
        setTimeout(() => {
            super.goSelf('/netscaler-ssldtlsprofile');
