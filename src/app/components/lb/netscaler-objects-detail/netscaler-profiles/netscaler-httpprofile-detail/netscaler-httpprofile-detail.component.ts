...
@Component({
    selector: 'app-netscaler-httpprofile-detail',
    ...
    styleUrls: ['./netscaler-httpprofile-detail.component.css']
})
export class NetscalerHTTPProfileDetailComponent extends GenericObjectChartDetailComponent {
    ...
    ngOnInit(): void {
        ...
        super.ngOnInit();
        this.component = this.netscalerService.getHTTPProfile(this.id, this.hostname);
    ...
    public goSelf(): void {
        setTimeout(() => {
            super.goSelf('/netscaler-httpprofile');
