...
@Component({
    selector: 'app-netscaler-sslprofile-detail',
    templateUrl: '../../../generic-object-chart-detail/generic-object-chart-detail.component.html',
    styleUrls: ['./netscaler-sslprofile-detail.component.css']
})
export class NetscalerSSLProfileDetailComponent extends GenericObjectChartDetailComponent {
    ...
    ngOnInit(): void {
        ...
        super.ngOnInit();
        this.component = this.netscalerService.getSSLProfile(this.id, this.hostname);
    ...
    public goSelf(): void {
        setTimeout(() => {
            super.goSelf('/netscaler-sslprofile');
