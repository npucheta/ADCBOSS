...
@Component({
    selector: 'app-netscaler-net-profile-detail',
    ...
    styleUrls: ['./netscaler-net-profile-detail.component.css']
})
export class NetscalerNetProfileDetailComponent extends GenericObjectChartDetailComponent {
    ...
    ngOnInit(): void {
        ...
        super.ngOnInit();
        this.component = this.netscalerService.getNETProfile(this.id, this.hostname);
    ...
    public goSelf(): void {
        setTimeout(() => {
            super.goSelf('/netscaler-netprofile');
