...
@Component({
  selector: 'app-device-a10',
  templateUrl: './device-a10.component.html',
  styleUrls: []
})
export class DeviceA10Component implements TypeDeviceInterface, OnInit, AfterViewInit, OnDestroy {
    ...
    data: ChannelService;
    readonly SELF_CHANNEL = channels.CHANNEL_FOR_APP_DEVICE_A10; // this should be unique

    constructor(private _cd: ChangeDetectorRef, public sharingDataService: SharingDataService,public a10Service:A10Service) {
    }
            ...
            .subscribe(data => {
                if (isForMe(this.SELF_CHANNEL, data.to)) {
                    if (environment.DEBUG) {
                        console.log('from init A10 action ==>', data);
                    }
                    this.data = data;
    ...
    public save() {
        ...
        this.parent.loadbalancerService = this.a10Service;
